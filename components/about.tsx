...
export function About() {
  ...
  const defaultInfo = {
    ...
    background: {"image":"","video":"","color":"#fffdc7","opacity":0.3},
    ...
    storyImage: "/uploads/about-image-1765035609621.jpg",
    hobbies: ["✍️ 글쓰기","🎵 음악 감상","☕ 카페 투어","🌱 산책하기"]
  }
